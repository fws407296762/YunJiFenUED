...
<div id="rightbox" class="rightbox">
	...
	<div id="rightcon" class="clfix rightcon">
		...
		<p id="badge_tab" class="badge_tab">
			...
			<a href="bindAccount.php" class="cur" data-id="3">会员绑定账号后自动回复</a>&nbsp;&nbsp; | &nbsp;&nbsp;
		...
		<div class="tablelist mtop10">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<th align="left"><div class="pdlr10">规则:<span class="r-title">会员绑定账号引导回复</span></div></th>
					</tr>
				</thead>
				<tbody>
					<tr>
		...
		<div class="tablelist mtop10">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<th align="left" colspan="2"><div class="pdlr10">规则:<span class="r-title">会员绑定账号引导回复</span></div></th>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td>
							<div class="pdlr10">
								<div class="mtop10">
									<span class="send_lefttxt">绑定奖励：</span>
									<div class="send_r_con">
										<input type="number" class="input25 score" />积分 
										<span class="graycolor">(不奖励则无需填写）</span>
										<div>
											<a href="#" class="petitebtn ok">确定</a>
										</div>
									</div>
								</div>
							</div>
